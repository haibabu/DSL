 ...
 * <ul>
 *   <li>{@link org.babu.xtext.training.smallfunc.smallFuncDsl.impl.smallClassTypeImpl#getType <em>Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class smallClassTypeImpl extends DataTypeImpl implements smallClassType
{
  ...
  {
    return SmallFuncDslPackage.Literals.SMALL_CLASS_TYPE;
  }
    ...
    if (type != null && type.eIsProxy())
    {
      ...
      if (type != oldType)
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, SmallFuncDslPackage.SMALL_CLASS_TYPE__TYPE, oldType, type));
      }
    }
    return type;
  }
  ...
  public void setType(SmallClass newType)
  {
    ...
    type = newType;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SmallFuncDslPackage.SMALL_CLASS_TYPE__TYPE, oldType, type));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case SmallFuncDslPackage.SMALL_CLASS_TYPE__TYPE:
