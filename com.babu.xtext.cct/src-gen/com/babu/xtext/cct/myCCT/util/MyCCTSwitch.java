 ...
 * @generated
 */
public class MyCCTSwitch<T> extends Switch<T>
{
  /**
  ...
  protected T doSwitch(int classifierID, EObject theEObject)
  {
    switch (classifierID)
    {
      ...
      {
        CCT cct = (CCT)theEObject;
        T result = caseCCT(cct);
  ...
  /**
   * Returns the result of interpreting the object as an instance of '<em>CCT</em>'.
   * <!-- begin-user-doc -->
   * This implementation returns null;
   * returning a non-null result will terminate the switch.
   * <!-- end-user-doc -->
   * @param object the target of the switch.
   * @return the result of interpreting the object as an instance of '<em>CCT</em>'.
   * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
   * @generated
   */
  public T caseCCT(CCT object)
  {
    return null;
  }
