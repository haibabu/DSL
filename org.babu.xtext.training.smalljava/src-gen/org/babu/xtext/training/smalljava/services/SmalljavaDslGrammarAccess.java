...
* generated by Xtext
*/
package org.babu.xtext.training.smalljava.services;
...
public class SmalljavaDslGrammarAccess extends AbstractGrammarElementFinder {
	...
	public class NameSpaceElements extends AbstractParserRuleElementFinder {
		...
		private final Assignment cSmallClassAssignment_3 = (Assignment)cGroup.eContents().get(3);
		private final RuleCall cSmallClassSmallClassParserRuleCall_3_0 = (RuleCall)cSmallClassAssignment_3.eContents().get(0);
		
		//NameSpace:
		//	"namespace" name=QName imports+=Import* smallClass=SmallClass;
		...
		public Assignment getSmallClassAssignment_3() { return cSmallClassAssignment_3; }

		//SmallClass
		public RuleCall getSmallClassSmallClassParserRuleCall_3_0() { return cSmallClassSmallClassParserRuleCall_3_0; }
	}
	...
	protected Grammar internalFindGrammar(GrammarProvider grammarProvider) {
		...
		while (grammar != null) {
			if ("org.babu.xtext.training.smalljava.SmalljavaDsl".equals(grammar.getName())) {
				return grammar;
			}
